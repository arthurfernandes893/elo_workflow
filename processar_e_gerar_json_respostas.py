    ...
    try:
        ...
        for msg_id in message_ids:
            ...
            try:
                ...
                print(f"E-mail processado com sucesso. {len(updates)} atualização(ões) extraída(s).")
                # MARCA O E-MAIL COMO LIDO para não processar de novo
                mail.store(msg_id, '+FLAGS', '\\Seen')
            except json.JSONDecodeError:
                print(f"AVISO: Gemini não retornou um JSON válido para um dos e-mails. E-mail será mantido como não lido.")
